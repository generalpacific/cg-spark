...
public class PartitionReducer implements Function2<JavaRDD<Point>,
        JavaRDD<Point>, JavaRDD<Point>> {

    private static final long serialVersionUID = 1252846659216541901L;

    public JavaRDD<Point> call(JavaRDD<Point> v1, JavaRDD<Point> v2) throws
            Exception {
