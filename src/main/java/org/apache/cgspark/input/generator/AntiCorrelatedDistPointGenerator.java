...
public class AntiCorrelatedDistPointGenerator implements PointGenerator {
  private final Rectangle mbr;
  private final Random random;
  private final double rho;

  public AntiCorrelatedDistPointGenerator(final Rectangle mbr,
      final Random random, final double rho) {
    this.mbr = mbr;
    this.random = random;
    this.rho = rho;
  }
